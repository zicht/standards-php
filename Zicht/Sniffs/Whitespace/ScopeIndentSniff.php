 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Zicht_Sniffs_Whitespace_ScopeIndentSniff extends Generic_Sniffs_WhiteSpace_ScopeIndentSniff
{
            ...
            if ($newline === true && $tokens[$i]['code'] !== T_WHITESPACE) {
                ...
                if ($column !== $indent) {
                    if ($this->exact === true || $column < $indent) {
                        ...
                        if($tokens[$firstToken]['column'] == 1 && $tokens[$firstToken]['code'] == T_COMMENT) {
                            // allow comments to start on the first line
                        } else {
